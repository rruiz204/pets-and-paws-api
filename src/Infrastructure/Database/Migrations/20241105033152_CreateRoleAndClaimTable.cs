...
{
    /// <inheritdoc />
    public partial class CreateRoleAndClaimTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Responsible for the overall management of the system, with full access to all functions and configurations.", "admin" });
