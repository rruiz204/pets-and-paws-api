...
namespace pets_and_paws_api.App.Infrastructure.Database.Migrations
{
    ...
    [Migration("20240913172508_AddTesterUserAndRole")]
    partial class AddTesterUserAndRole
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pets_And_Paws_Api.App.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Description = "Responsible for testing and ensuring the quality of software",
                            Name = "tester"
                        });
                });
